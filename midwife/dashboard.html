...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav>
                <ul class="nav-menu">
                    <li><a href="#" class="midwife-name">Madhavi Perera</a></li>
        ...
        <div class="content-with-sidebar">
            ...
            <div id="dashboard" class="content-section">
                ...
                <div class="row" style="margin-bottom: 2rem;">
                    <div class="col-3">
                        <div class="card" style="border-left: 4px solid var(--primary-blue); text-align: center; padding: 1.5rem;">
                            <div style="font-size: 2rem; font-weight: 700; color: var(--primary-blue);">12</div>
                            <div style="font-size: 0.75rem; font-weight: 600; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.5rem;">Activities This Week</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card" style="border-left: 4px solid var(--accent-teal); text-align: center; padding: 1.5rem;">
                            <div style="font-size: 2rem; font-weight: 700; color: var(--primary-blue);">8</div>
                            <div style="font-size: 0.75rem; font-weight: 600; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.5rem;">Home Visits</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card" style="border-left: 4px solid var(--secondary-green); text-align: center; padding: 1.5rem;">
                            <div style="font-size: 2rem; font-weight: 700; color: var(--primary-blue);">25</div>
                            <div style="font-size: 0.75rem; font-weight: 600; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.5rem;">Patients Served</div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card" style="border-left: 4px solid #fd7e14; text-align: center; padding: 1.5rem;">
                            <div style="font-size: 2rem; font-weight: 700; color: var(--primary-blue);">3</div>
                            <div style="font-size: 0.75rem; font-weight: 600; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; margin-top: 0.5rem;">Pending Reports</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="schedule-item">
                                    ...
                                    <div>
                                        ...
                                        <p>Mrs. K. Silva - Follow-up consultation</p>
                                    </div>
                                </div>
                                <div class="schedule-item">
                                    ...
                                    <div>
                                        ...
                                        <p>Clinic Center - BCG vaccinations</p>
                                    </div>
                                </div>
                                <div class="schedule-item">
                                ...
                                <div class="schedule-item">
                                    ...
                                    <div>
                                        ...
                                        <p>Community Center - Nutrition talk</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="activity-log-item">
                                    <div>
                                        ...
                                        <p>Mrs. D. Jayawardene - Yesterday 15:30</p>
                                    </div>
                                ...
                                <div class="activity-log-item">
                                    <div>
                                        ...
                                        <p>5 children vaccinated - Yesterday 11:00</p>
                                    </div>
                                    <span class="status-badge status-active">Completed</span>
                                </div>
                                <div class="activity-log-item">
                                    <div>
                                        ...
                                        <p>Weekly activity report - Monday</p>
                                    </div>
                                ...
                                <div class="activity-log-item">
                                    <div>
                                        ...
                                        <p>New mother guidance - Monday 14:00</p>
                                    </div>
                                    <span class="status-badge status-active">Completed</span>
                                </div>
                            </div>
            ...
            <div id="home-visits" class="content-section" style="display: none;">
                ...
                <div class="tab-container">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="#" onclick="switchVisitTab('scheduled')">Scheduled Visits</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="switchVisitTab('completed')">Completed Visits</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="switchVisitTab('route-planning')">Route Planning</a>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Route Planning Tab -->
                <div id="route-planning" class="tab-content" style="display: none;">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Optimize Your Daily Route</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-8">
                                        <div class="route-map">
                                            <div class="map-placeholder">
                                                ...
                                                <button class="btn btn-primary" onclick="loadMap()">Load Route Map</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="route-summary">
                                            ...
                                            <div class="route-stats">
                                                <div class="stat-item">
                                                    ...
                                                    <span class="value">24.5 km</span>
                                                </div>
                                                <div class="stat-item">
                                                    <span class="label">Estimated Time:</span>
                                                    <span class="value">3h 45min</span>
                                                </div>
                                                <div class="stat-item">
                                                    <span class="label">Visits:</span>
                                                    <span class="value">8 patients</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="route-order">
                                                <div class="route-stop">
                                                    ...
                                                    <span class="stop-name">Mrs. Nirmala Fernando</span>
                                                </div>
                                                <div class="route-stop">
                                                    <span class="stop-number">2</span>
                                                    <span class="stop-name">Mrs. Kamani Wickramasinghe</span>
                                                </div>
                                                <div class="route-stop">
                                                    <span class="stop-number">3</span>
                                                    <span class="stop-name">Mrs. Sandya Peris</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div id="profile" class="content-section" style="display: none;">
                                ...
                                <div class="card-body text-center">
                                    <div class="profile-picture-container">
                                        <div class="profile-picture" id="profileImage" role="button" tabindex="0" aria-label="View profile photo" onclick="openProfileImagePreview()" onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();openProfileImagePreview();}">
                                            <img src="../profile%20picture.png" alt="Midwife Profile Picture">
                                        </div>
                                    </div>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h4 class="card-title"><i class="fas fa-map-marker-alt"></i> My Duty Areas</h4>
                        <p class="mb-0 text-muted">Service areas under your responsibility</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6 col-lg-3 mb-3">
                                <div class="duty-area-card" style="cursor: default; pointer-events: none;">
                                    <div class="duty-area-icon">
                                        <i class="fas fa-home"></i>
                                    </div>
                                    <div class="duty-area-name">Udathuththiripitiya</div>
                                    <div class="duty-area-status">
                            ...
                            <div class="col-6 col-lg-3 mb-3">
                                <div class="duty-area-card" style="cursor: default; pointer-events: none;">
                                    ...
                                    <div class="duty-area-name">Kahabilihena</div>
                                    <div class="duty-area-status">
                            ...
                            <div class="col-6 col-lg-3 mb-3">
                                <div class="duty-area-card" style="cursor: default; pointer-events: none;">
                                    ...
                                    <div class="duty-area-name">Opathella</div>
                                    <div class="duty-area-status">
                                        <span class="status-badge status-secondary">Secondary</span>
                                    </div>
                                </div>
                            ...
                            <div class="col-6 col-lg-3 mb-3">
                                <div class="duty-area-card" style="cursor: default; pointer-events: none;">
                                    ...
                                    <div class="duty-area-name">Ambalangoda</div>
                                    <div class="duty-area-status">
                                        <span class="status-badge status-secondary">Secondary</span>
                                    </div>
                                </div>
                        ...
                        <div class="duty-area-summary mt-3">
                            <div class="row">
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <div class="summary-stat">
                                        <div class="summary-number">1,245</div>
                                ...
                                <div class="col-3">
                                    <div class="summary-stat">
                                        ...
                                        <div class="summary-label">Pregnant Mothers</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary" onclick="showDistributionForm()">Record New Distribution</button>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-info btn-block mb-3" onclick="generateTriposhaPeport()">
            ...
            <div class="area-content-wrapper" data-area="kahabilihena">
                <div class="area-header">
                    <h4><i class="fas fa-map-marker-alt"></i> Kahabilihena Area - Triposha Distribution</h4>
                    <p>Coverage: 12 villages | Beneficiaries: 68 families | Distribution Center: Kahabilihena RH</p>
                </div>
                <div class="dashboard-stats">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Distributions - Kahabilihena</h4>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
            ...
            <div class="area-content-wrapper" data-area="opathella">
                <div class="area-header">
                    <h4><i class="fas fa-map-marker-alt"></i> Opathella Area - Triposha Distribution</h4>
                    <p>Coverage: 8 urban wards | Beneficiaries: 52 families | Distribution Center: Opathella PHC</p>
                </div>
                <div class="dashboard-stats">
                    <div class="stat-card info">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Distributions - Opathella</h4>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
            ...
            <div class="area-content-wrapper" data-area="ambalangoda">
                <div class="area-header">
                    <h4><i class="fas fa-map-marker-alt"></i> Ambalangoda Area - Triposha Distribution</h4>
                    <p>Coverage: 18 villages | Beneficiaries: 95 families | Distribution Center: Ambalangoda DH</p>
                </div>
                <div class="dashboard-stats">
                    <div class="stat-card info">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Distributions - Ambalangoda</h4>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
    ...
    <script>
        ...
        function addScheduleItem() {
            alert('Add schedule item functionality would be implemented here');
        }
                    ...
                    <div class="modal-body">
                        <form id="newVisitForm">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required>
                                            ...
                                            <option value="1">Mrs. Amara Silva</option>
                                            <option value="2">Mrs. Nayani Perera</option>
                                            <option value="3">Mrs. Kumari Fernando</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" placeholder="Additional notes for the visit..."></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" onclick="closeModal()">Cancel</button>
                        <button type="submit" form="newVisitForm" class="btn btn-primary">Schedule Visit</button>
                    </div>
                </div>
            `;
                        ...
                        <form id="quickLogForm">
                            <div class="form-group">
                                ...
                                <select class="form-control" required>
                                    ...
                                    <option value="1">Mrs. Nirmala Fernando - 09:00</option>
                                    <option value="2">Mrs. Kamani Wickramasinghe - 10:30</option>
                                    <option value="3">Mrs. Sandya Peris - 14:00</option>
                                </select>
                            </div>
                            <div class="row">
                                <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" required placeholder="Brief summary of the visit, findings, and actions taken..."></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" onclick="closeModal()">Cancel</button>
                        <button type="submit" form="quickLogForm" class="btn btn-success">Log Visit</button>
                    </div>
                </div>
            `;
            document.body.appendChild(modal);
        ...
        function switchVisitTab(tabName) {
            ...
            const selectedTab = document.getElementById(tabName + '-visits') || document.getElementById(tabName);
            if (selectedTab) {
        ...
        function viewPatientDetails(patientId) {
            alert(`Viewing detailed information for patient ID: ${patientId}`);
            // Implementation would show patient history and details
        }
        ...
        function switchArea(sectionId, areaName) {
            ...
            // Remove active class from all area buttons in this section
